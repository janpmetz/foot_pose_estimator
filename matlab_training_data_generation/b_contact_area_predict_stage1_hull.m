...
% 
% 3. Calculate the convex hull, convert it to a map of triangles
%   such that each triangle has a distinct class value
% 
...
n = 2000;           % number of training pairs to generate
...
for i = 1:n    
    ...
    [hullClsMap] = getFootHold_hull_multi_triangles(Terrain, Foot, showPlots);      
        
    % assemble the training pair now
    ZData = Foot.Z;
    row = [ZData(:); hullClsMap(:)];
